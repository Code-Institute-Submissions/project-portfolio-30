...
def page_cherry_leaf_visualiser_body():
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      st.image(avg_powdery_mildew, caption='Powdery Mildew Infected Leaf - Average and Variability')
      st.image(avg_healthy, caption='Healthy Leaf - Average and Variability')
      st.write("---")

    if st.checkbox("Differences between a healthy cherry leaf from one with powdery mildew."):
